  ...
  class Gradient {
    ...
    async connect() {
        this.shaderFiles = {
            ...
            fragment: "varying vec3 v_color;\n\nvoid main() {\n  vec3 color = v_color;\n  if (u_darken_top == 1.0) {\n    vec2 st = gl_FragCoord.xy/resolution.xy;\n    color.g -= pow(st.y + sin(-12.0) * st.x, u_shadow_power) * 0.4;\n  }\n  float grain = snoise(vec3(gl_FragCoord.xy * 0.45, u_time * 0.001));\n  color += (grain - 0.5) * 0.025;\n  gl_FragColor = vec4(clamp(color, 0.0, 1.0), 1.0);\n}"
        },
        this.conf = {
            presetName: "",
            wireframe: false,
    ...
    initMaterial() {
        ...
        return this.vertexShader = [this.shaderFiles.noise, this.shaderFiles.blend, this.shaderFiles.vertex].join("\n\n"), new this.minigl.Material(this.vertexShader, [this.shaderFiles.noise, this.shaderFiles.fragment].join("\n\n"), this.uniforms)
    }
    initMesh() {
